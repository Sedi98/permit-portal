# Ödəniş → Təsdiq → İmza → PDF — Tam Zəncir (Frontend Bələdçisi)

Bu, icraçının, ödəniş cədvəlini hazırlamasından, Nazir müavininin, son imzasına, PDF-in yaranmasına qədər, **bütün, 6 addımı**, əhatə edir.
